export const getVirtualCertificateTemplate = (
  qr_code: string,
  qr_course: string,
  course_type: string,
  time: string,
    ...
    <style>
      ...
      * {
      ...
      .certificado-mintel-Yjy .auto-group-fq63-nRu .group-481757-i4f {
        ...
        display: flex;
        flex-direction: column;
        background: linear-gradient(224.82deg, #029df4 10%, #ffffff 90%);
      }
      .certificado-mintel-Yjy
        .auto-group-fq63-nRu
        .group-481757-i4f
    ...
    <div class="certificado-mintel-Yjy">
      <div class="auto-group-hlaj-RSP">
        ...
        >
          ...
          <img src="${course_logo}" width="82px"
          height="62px"/>
        </div>
        <div class="auto-group-jnyx-BTV">
            ...
            <p class="certifica-a3h">CERTIFICAN</p>
          </div>
        ...
        <div class="auto-group-5kzu-3AX">
          ...
          <p class="para-validar--mEw">Para validar:</p>
        </div>
